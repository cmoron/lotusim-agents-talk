...
> Talk ~13-14 min · LOTUSim Technical Conference · Naval Group · 2 July 2026
...
> **11 slides** — the Linux kernel and OpenClaw share one slide (slide 5). Numbers below match the deck.
...
**Budget (~13-14 min):**
1 Cover 0:45 · 2 Wall 1:00 · 3 Agents 0:45 · 4 Why now 1:15 · 5 Industry (Linux + OpenClaw) 2:30 · 6 Scenario 1:00 · 7 Relay 0:45 · 8 Demo 2:30 · 9 Limits 1:15 · 10 Almost agent-ready 1:30 · 11 Close 1:00

**Arc (Acte 1 problem → Acte 2 proof → Acte 3 method → Acte 4 contract):** open on the wall, drop the "plan" line on slide 4, keep the industry proof (Linux + OpenClaw, one slide) before the LOTUSim sailboat block, let the demo carry the method, finish on the two contracts.
...
- **Say:** _"In this talk: how AI agents bring down the entry barrier of a ROS / Gazebo / Xdyn simulator — and what the project can do in return."_
...
- Three axes:
  ...
  - **implicit conventions, never written down.** ← remember this, it pays off on slide 10.
...
- **Right — OpenClaw.** _"The opposite temperament: the fastest-growing open-source project in GitHub history, built agent-first — about 381k stars as of 1 July 2026."_
  ...
  - The scale, as an aside and **attributed to Steinberger's small team** (NOT "the project", don't conflate): _"Steinberger's small team runs around a hundred agents in parallel, about 1.3 million dollars of tokens in one month, funded by OpenAI."_
...
- **Say (verbatim, seed for slide 10):** _"An agent is only as good as the docs and the rules you give it."_
- **Bridge to LOTUSim (verbatim):** _"Let me show you the same discipline on a real LOTUSim feature."_
- **Stats refresh J-1 done, 1 July 2026:** the slide shows `381k ★` as a tag. Re-sampled with the GitHub API: `381,221` stars at 07:18 Europe/Paris.
...
## 8 · Demo — video _(2:30)_

- This is my breather and now carries the "how". Let the video play (mostly sped up, back to real time on the key moments); say little. The video = the full session, ending on the sailboat rounding the buoy in LOTUSim.
...
- ⚠️ PREP CHECK: video is **done and embedded** in slide 8 as `media/demo.mp4` (2:19, 1920×1080). The contribution itself is **shipped**: 6 signed PRs are live on the `cmoron-lab` forks (Assisted-by + I sign) — usable if anyone asks "was this real?". See `docs/demo-sailboat.md`.

## 9 · Limits — what I'm not selling _(1:15)_
...
## 10 · LOTUSim is almost agent-ready _(1:30)_ — the governance message, stay POSITIVE (we work for LOTUSim)
...
- **"OpenClaw's security record? (150+ CVEs in months)"** → Yes, and that's the cautionary half of the lesson: governance must precede scale, not chase it. It's exactly why SECURITY.md belongs in the governance backlog before the agents arrive.
