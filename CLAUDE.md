...
## Current state & open items (2026-06-24)
...
1 Cover · 2 The wall · 3 Disambiguation (two senses of "agent") · 4 Why now (closes on **the question**) · 5 **Industry · two answers** (kernel + OpenClaw) · 6 Scenario (sonar) · 7 Pipeline overview (the relay sprites) · 8 The loop in action · 9 Demo · 10 Limits / honesty · 11 LOTUSim's homework · 12 Close.
